package com.chuhx.hellpclient;

import com.chuhx.zookeeper.ZookeeperServiceDiscovery;
import org.springframework.boot.SpringApplication;
import org.springframework.boot.autoconfigure.SpringBootApplication;
import com.chuhx.RpcProxy;
import com.chuhx.HelloService;

@SpringBootApplication
public class HellpclientApplication {


    public static void main(String[] args) {
        SpringApplication.run(HellpclientApplication.class, args);

        ZookeeperServiceDiscovery zookeeperServiceDiscovery = new ZookeeperServiceDiscovery("127.0.0.1:2181");
        RpcProxy rpcProxy = new RpcProxy(zookeeperServiceDiscovery);
        /**
